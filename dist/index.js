...
var _lexer = __webpack_require__(31);
...
var __main = function __main() {
    ...
    var tokens = _lexer2.default.tokenizer('"test"');
...
exports.JsString = exports.JsObject = undefined;
...
var JsObject = function () {
    function JsObject(token) {
        (0, _classCallCheck3.default)(this, JsObject);

        this.token = token;
    }

    (0, _createClass3.default)(JsObject, [{
        key: "toString",
...
var JsString = function (_JsObject) {
    (0, _inherits3.default)(JsString, _JsObject);

    function JsString(token) {
        (0, _classCallCheck3.default)(this, JsString);
        return (0, _possibleConstructorReturn3.default)(this, (JsString.__proto__ || (0, _getPrototypeOf2.default)(JsString)).call(this, token));
    }
...
var _js_object = __webpack_require__(47);
...
var Parser = function () {
    ...
    (0, _createClass3.default)(Parser, [{
        ...
        value: function parse() {
            ...
            var parsers = ['parseString', 'parseNumber', 'parseIdent'].concat(kwKeys.map(function (v, k) {
                return 'parse' + v;
            }));
            //console.log(parsers)
        ...
        value: function parseString() {
            return new _js_object.JsString(this.tokens[this.curr++]);
        }
    }, {
        key: 'parseNumber',
